...
import "../BestTimeToVisit10/BestTimeToVisit.css"


const FrontPage = () => {
  return (
    <div className='container'>
        <h4 className='primary-heading mt-5 text-start ps-2'>TAMILNADU TOURISM</h4>
        <h3 className='text-start ps-2'>Best Time To Visit</h3>
        <br />
    
    <Row className="">
        <Col md={6}  className="text-right ps-0">
            <img
                src={require("../../Gallery/Climate.jpeg")}
                alt="BestTimeToVisit"
                className="myImage"  
            />
        ...
        <Col md={5} className='ms-5'> 
            <br />
            <h5 className='season-heading bolder mb-5 ms-4'>
            ...
            <Accordion defaultActiveKey="0" style={{width:"500px"}}>
               <Accordion.Item eventKey="0">
                  ...
                  <Accordion.Body className='season-text'>
                     ...
                     <img 
                         src={require("../../Gallery/image.jpeg")}
               ...
               <Accordion.Item eventKey="1">
                  ...
                  <Accordion.Body className='season-text'>
                     ...
                     <img 
                         src={require("../../Gallery/image1.jpeg")}
              ...
              <Accordion.Item eventKey="2">
                  ...
                  <Accordion.Body className='season-text'>
                     ...
                     <img 
                         src={require("../../Gallery/image2.jpeg")}
