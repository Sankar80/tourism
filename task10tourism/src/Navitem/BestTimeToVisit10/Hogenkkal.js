...
import Hogenkkal1 from '../../Gallery/hogenakkal1 (1).jpeg'
import Hogenkkal2 from '../../Gallery/hogenakkal1 (3).jpeg'
import Hogenkkal3 from '../../Gallery/hogenakkal1 (2).jpeg'
...
const Hogenkkal = () => {
  ...
  return (
    <div className='container'>
      <h3 className='besttimetovisit-primary-heading'>10. Hogenkkal</h3>
      <Row className="align-items-center" style={{marginTop:"-70px",marginLeft:"-20px" }}>
        <Col md={6}> 
          <div
            ...
            <Modal.Dialog show={isModalOpen} onHide={handleClose} backdrop={false}>
              <Modal.Header closeButton>
                <Modal.Title className='text-center modal-heading' style={{marginBottom:"-10px"}}>More About Best Time To Travel To Hogenkkal</Modal.Title>
              </Modal.Header>
              <Modal.Body className='mt-0' style={{marginBottom:"-30px" , marginTop:"-10px"}}>
