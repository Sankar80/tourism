...
import '../BestTimeToVisit10/Chennai.css'
import { Row,Col } from 'react-bootstrap'
import {Button,Offcanvas } from 'react-bootstrap';
import Modal from 'react-bootstrap/Modal';
import Kanyakumari1 from '../../Gallery/kanyakumari1 (1).jpeg'
import Kanyakumari2 from '../../Gallery/kanyakumari1 (3).jpeg'
import Kanyakumari3 from '../../Gallery/kanyakumari1 (2).jpeg'
    ...
    <div className='container'>
      <Row className="align-items-center">
        <Col md={6}  className="text-right">
          <h3 className='besttimetovisit-primary-heading'>05. Kanyakumari</h3>
        ...
        <Col md={6} className='model-margintop mt-5'> 
         <div
