...
import Kodaikanal1 from '../../Gallery/kodaikanal1.jpeg'
import Kodaikanal2 from '../../Gallery/kodaikanal2.jpeg'
import Kodaikanal3 from '../../Gallery/kodaikanal3.jpeg'
    ...
    <div className='container'>
      <Row className="align-items-center">
        <Col md={6}  className="text-right">
          <h3 className='besttimetovisit-primary-heading'>03. Kodaikanal</h3>
