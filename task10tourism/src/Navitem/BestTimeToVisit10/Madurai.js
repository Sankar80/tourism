...
import Madurai1 from '../../Gallery/madurai1.jpeg'
import Madurai2 from '../../Gallery/madurai2.jpeg'
import Madurai3 from '../../Gallery/madurai3.jpeg'
    ...
    <div className='container'>
      <Row className="align-items-center">
        <Col md={6}  className="text-right">
          <h3 className='besttimetovisit-primary-heading'>07. Madurai</h3>
