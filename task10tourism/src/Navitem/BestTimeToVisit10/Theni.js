...
import Theni1 from '../../Gallery/theni1.jpeg'
import Theni2 from '../../Gallery/theni2.jpeg'
import Theni3 from '../../Gallery/theni3.jpeg'
    ...
    <div className='container'>
      <Row className="align-items-center">
        <Col md={6}  className="text-right">
          <h3 className='besttimetovisit-primary-heading'>09. Theni</h3>
