...
import Food3 from "../Food/Food2.jpg"
import Food2 from "../Food/Food3.jpeg"
  ...
  return (
    <Container>
        <section className='d-flex mt-5 pt-4'>
            <div className='me-5'>
            <h4 className='mb-4 text-start tb'>Famous & Local Food of Tamil Nadu</h4>
        ...
        <h4 className='text-center m-5 p-5 pt-3 tb'>TAMILNADU<br></br>FAMOUS AND LOCAL FOODS</h4>
        <section className='d-flex mb-5'>
            <div className='p-4 pb-2 border'
                ...
                <h5 className='text-center mt-2 mb-4 tb'>Food of Chennai</h5>
            ...
            <div className='p-4 pb-2 border'
                ...
                boxShadow:'2px 2px 5px 3px gray'}}>
                <h5 className='text-center mt-2 mb-4 tb'>Food of Rameshwaram</h5>
                <p style={{textAlign:'justify',textIndent:'15%',boxShadow:'40px'}}>
        ...
        <section className='d-flex mb-5'>
            <div className='p-4 pb-2 border'
                style={{marginLeft:'3em',width:'28em',borderRadius:'6%',
                boxShadow:'2px 2px 5px 3px gray'}}>
                <h5 className='text-center mt-2 mb-4 tb'>Food of Kodaikanal</h5>
                <p style={{textAlign:'justify',textIndent:'15%',boxShadow:'40px'}}>
            ...
            <div className='p-4 pb-2 border'
                style={{marginLeft:'7em',width:'28em',borderRadius:'6%',
                boxShadow:'2px 2px 5px 3px gray'}}>
                <h5 className='text-center mt-2 mb-4 tb'>Food of Ooty</h5>
                <p style={{textAlign:'justify',textIndent:'15%',boxShadow:'40px'}}>
        ...
        <section className='d-flex mb-5'>
            <div className='p-4 pb-2 border'
                style={{marginLeft:'3em',width:'28em',borderRadius:'6%',
                boxShadow:'2px 2px 5px 3px gray'}}>
                <h5 className='text-center mt-2 mb-4 tb'>Food of Kanyakumari</h5>
                <p style={{textAlign:'justify',textIndent:'15%',boxShadow:'40px'}}>
            ...
            <div className='p-4 pb-2 border'
                style={{marginLeft:'7em',width:'28em',borderRadius:'6%',
                boxShadow:'2px 2px 5px 3px gray'}}>
                <h5 className='text-center mt-2 mb-4 tb'>Food of Kumbakonam</h5>
                <p style={{textAlign:'justify',textIndent:'15%',boxShadow:'40px'}}>
        ...
        <section className='d-flex mb-5'>
            <div className='p-4 pb-2 border'
                style={{marginLeft:'3em',width:'28em',borderRadius:'6%',
                boxShadow:'2px 2px 5px 3px gray'}}>
                <h5 className='text-center mt-2 mb-4 tb'>Food of Madurai</h5>
                <p style={{textAlign:'justify',textIndent:'15%',boxShadow:'40px'}}>
            ...
            <div className='p-4 pb-2 border'
                style={{marginLeft:'7em',width:'28em',borderRadius:'6%',
                boxShadow:'2px 2px 5px 3px gray'}}>
                <h5 className='text-center mt-2 mb-4 tb'>Food of Yercaud</h5>
                <p style={{textAlign:'justify',textIndent:'15%',boxShadow:'40px'}}>
        ...
        <section className='d-flex mb-5'>
            <div className='p-4 pb-2 border'
                style={{marginLeft:'3em',width:'28em',borderRadius:'6%',
                boxShadow:'2px 2px 5px 3px gray'}}>
                <h5 className='text-center mt-2 mb-4 tb'>Food of Hogenakkal</h5>
                <p style={{textAlign:'justify',textIndent:'15%',boxShadow:'40px'}}>
            ...
            <div className='p-4 pb-2 border'
                style={{marginLeft:'7em',width:'28em',borderRadius:'6%',
                boxShadow:'2px 2px 5px 3px gray'}}>
                <h5 className='text-center mt-2 mb-4 tb'>Food of Theni</h5>
                <p style={{textAlign:'justify',textIndent:'15%',boxShadow:'40px'}}>
